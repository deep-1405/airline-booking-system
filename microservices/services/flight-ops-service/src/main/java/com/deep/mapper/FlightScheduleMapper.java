...
public class FlightScheduleMapper {
    ...
    public static FlightSchedule toEntity(FlightScheduleRequest request, Flight flight) {
        ...
        return FlightSchedule.builder()
                ...
                .recurrenceType(request.getRecurrenceType() != null ? request.getRecurrenceType() : RecurrenceType.DAILY)
                .operatingDays(request.getOperatingDays())
                .isActive(request.getIsActive() != null ? request.getIsActive() : true)
                .build();
    }

    public static FlightScheduleResponse toResponse(FlightSchedule fs, AirportResponse arrival, AirportResponse departure) {
