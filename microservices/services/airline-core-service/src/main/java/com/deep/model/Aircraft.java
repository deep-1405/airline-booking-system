...
public class Aircraft {
    ...
    // with lazy hibernate loads only the aircraft, airline data is fetched only if your code actually accesses it.
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "airline_id", nullable = false)
    @NotNull(message = "Airline is required")
    // this means that many aircraft belonging to one airline
...
//        return status == AircraftStatus.ACTIVE && isAvailable == Boolean.TRUE;
    }
